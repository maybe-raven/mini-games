defmodule LightsOutGameWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LightsOutGameWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LightsOutGameWeb.Gettext, "errors", msg, opts)
    end
  end
